                ...
                <div className="popup-box" onClick={(e) => e.stopPropagation()}>
                  ...
                  <form>
                    ...
                    <div className="deadline-container">
                      ...
                      <div>
                        <select
                          className="deadlineUnit"
                          value={goal.deadlineUnit}
                          onChange={handleChange}
                        >
              ...
              <tbody>
                {goals.map((goalItem, index) => (
                  <tr key={index}>
                    ...
                    <td>{goalItem.target}</td>
                    <td>{goalItem.outcome}</td>
                    <td>
                      {goalItem.deadlineValue} {goalItem.deadlineUnit}
                    </td>
                  </tr>
                ))}
              </tbody>
